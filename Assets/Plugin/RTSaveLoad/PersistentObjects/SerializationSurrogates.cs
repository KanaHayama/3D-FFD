...
namespace Battlehub.RTSaveLoad
{
	public static partial class SerializationSurrogates
	{
		static SerializationSurrogates()
		{
			...
			m_surrogates.Add(typeof(UnityEngine.Experimental.Director.PlayableGraph), new Battlehub.RTSaveLoad.UnityEngineNS.ExperimentalNS.DirectorNS.PlayableGraphSurrogate());
...
#endif
	{
        public static implicit operator UnityEngine.Experimental.Director.PlayableGraph(PlayableGraphSurrogate v)
        {
            return new UnityEngine.Experimental.Director.PlayableGraph();
        }
        public static implicit operator PlayableGraphSurrogate(UnityEngine.Experimental.Director.PlayableGraph v)
        {
